...
func InitDB(connection_string string) error {
	...
	schemaSQLs := []string{
		...
		"CREATE TABLE IF NOT EXISTS pulls (id BIGINT NOT NULL, repo VARCHAR(255) NOT NULL, data JSON, PRIMARY KEY (id, repo));",
		"CREATE TABLE IF NOT EXISTS pullsTest (id BIGINT NOT NULL, repo VARCHAR(255) NOT NULL, data JSON, PRIMARY KEY (id, repo));",
